...
#find . -type f -exec sed -i -e 's/X/Y/g' {}\;
FUNCTIONS+=",sere()"
sere(){
...
export PS1=$IBlack$Time12h$BICyan\@$Host$Color_Off'$(git branch &>/dev/null;\
if [ $? -eq 0 ]; then \
...
#PS1='\[\033[01;32m\][\t]\[\033[01;34m\]@\[\033[01;33m\]\h\[\033[00;34m\]{\[\033[01;34m\]\w\[\033[00;34m\]}\[\033[01;32m\]:\[\033[00m\]'

#weird ass prompt thingy
#PS1='\[\e[34m\]┌─[\[\e[37m\]\u@\h\[\e[34m\]] \n└─[\[\e[37m\]\W\[\e[34m\]]> '
...
clear
printf "${PURPLE}${bold}Custom Functions Enabled:${normal}\n"
printf $FUNCTIONS
printf "\n"
...
DEBEMAIL="rogersc@ainfosec.com"
DEBFULLNAME="Chris Rogers"
